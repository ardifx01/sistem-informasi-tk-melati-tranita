  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.createPelanggaran({
        ...
        tingkatPelanggaran: formData.tingkatPelanggaran as
          | "RINGAN"
          | "SEDANG"
          | "BERAT",
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, jenisPelanggaran: value })
                }
              >
                <SelectTrigger className="col-span-3">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="tidak-mengerjakan-tugas">
                    Tidak mengerjakan tugas
                  </SelectItem>
                  <SelectItem value="tidak-berseragam">
                    Tidak berseragam
                  </SelectItem>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                value={formData.tingkatPelanggaran}
                onValueChange={(value) =>
                  setFormData({ ...formData, tingkatPelanggaran: value })
                }
              >
                <SelectTrigger className="col-span-3">
