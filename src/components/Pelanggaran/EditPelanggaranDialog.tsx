...
export function EditPelanggaranDialog({
  pelanggaran,
  open,
  onOpenChange,
  ...
  useEffect(() => {
    if (pelanggaran) {
      setFormData({
        ...
        tanggal:
          pelanggaran.tanggal instanceof Date
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("jenisPelanggaran", e.target.value)
                }
                className="col-span-3"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("tingkatPelanggaran", value)
                  }
                >
                  <SelectTrigger>
