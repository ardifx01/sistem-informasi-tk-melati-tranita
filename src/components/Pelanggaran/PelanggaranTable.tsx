...
export function PelanggaranTable({
  ...
  const [editPelanggaran, setEditPelanggaran] = useState<Pelanggaran | null>(
    null
  );
        ...
        <TableBody>
          {data.map((pelanggaran) => (
            <TableRow key={pelanggaran.id}>
              ...
              <TableCell>
                <Badge
                  className={getTingkatColor(pelanggaran.tingkatPelanggaran)}
                >
